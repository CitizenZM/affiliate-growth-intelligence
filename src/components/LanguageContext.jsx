...
export const translations = {
  zh: {
    ...
    shared: {
      ...
      partialDataset: "部分数据集", partialModule: "模块部分可用",
      trigger: "触发因素", action: "行动", owner: "负责人", due: "截止时间",
      risk: "风险", opportunity: "机会", note: "备注",
    },
    datasetSelector: {
    ...
    overview: {
      ...
      emptyTitle: "暂无数据集",
      emptySubtitle: "请先在数据接入页面上传 CSV 文件",
      uploadData: "开始上传数据",
      loadingMetrics: "加载指标数据...",
      brandContextTitle: "Insta360 品牌语境",
      brandContextSubtitle: "已自动补充品牌和站点研究",
      promotionDetected: "检测到促销信息",
      brand: "品牌",
      productCategories: "产品类别",
      keySellingPoints: "核心卖点",
      datasetWarnings: "数据集警告",
      notAvailable: "暂无",
      placeholders: { selectDataset: "选择数据集", status: "状态" },
      kpis: {
        activeRatio: "活跃率", contentShare: "Content GMV 占比", dealShare: "Deal GMV 占比",
        gmvPerActive: "单活跃 Publisher GMV", top10Share: "Top10 GMV 占比", approvalRate: "审批率",
        totalGmv: "总 GMV", publishersTo50: "50% GMV 所需",
      },
      labels: {
    ...
    reportCenter: {
      title: "报告中心", subtitle: "研究增强型 Affiliate 报告，含市场、竞品与关键词附录",
      generateFull: "生成完整报告", generating: "生成中...",
      boardSummary: "Board 摘要版", boardSummaryLabel: "Board 摘要",
      chapterNav: "章节目录", exportFormats: "导出格式",
      chapterLabel: "章节", refresh: "刷新", loading: "加载中...", updatedAt: "最近更新", cacheHit: "缓存研究", sources: "研究来源",
      noContent: "点击\"生成完整报告\"后，此处将显示报告预览",
      noContentSub: "支持所见即所得编辑、图表替换、证据表嵌入",
      noContentText: "暂无内容",
      conclusion: "结论", keyFindings: "关键发现",
      findingLabels: { trigger: "触发因素", action: "行动", owner: "负责人", due: "截止时间" },
      downloads: { pdf: "下载 PDF", markdown: "下载 Markdown" },
      ...
      chapters: [
        { title: "Executive Summary", desc: "一页式经营摘要，连接 KPI、品类语境与优先动作" },
        { title: "Activation Funnel", desc: "激活率、沉睡伙伴与再激活机会" },
        { title: "Concentration Analysis", desc: "Pareto、Top10 风险与去集中化方向" },
        { title: "Mix Health", desc: "结构覆盖、类型缺口与招募方向" },
        { title: "Efficiency Quadrant", desc: "成本、订单与放大/治理判断" },
        { title: "Approval & Quality", desc: "交易质量、审批拆解与治理线索" },
        { title: "Tier Management", desc: "分层运营与差异化管理节奏" },
        { title: "Action Plan", desc: "30/60/90 天执行计划与 owner" },
        { title: "Timeline & Roadmap", desc: "阶段化推进节奏与里程碑" },
        { title: "Data Quality Assessment", desc: "数据局限、部分能力与置信度说明" },
        { title: "Appendix - Methodology", desc: "指标、研究与推导方法" },
        { title: "Category Landscape", desc: "品类需求、货盘与 Affiliate 适配度" },
        { title: "Competitor Benchmark", desc: "竞品定位、价格、促销与 Affiliate 启示" },
        { title: "Keyword Opportunity Map", desc: "品牌词、品类词、竞品词与意图词机会" },
        { title: "Brand Positioning & Creative Hooks", desc: "品牌叙事、卖点钩子与内容素材方向" },
        { title: "Research Sources", desc: "报告引用来源与研究置信说明" },
      ],
    },
    dataCenter: {
  ...
  en: {
    ...
    shared: {
      ...
      partialDataset: "Partial dataset", partialModule: "Partial module",
      trigger: "Trigger", action: "Action", owner: "Owner", due: "Due",
      risk: "Risk", opportunity: "Opportunity", note: "Note",
    },
    datasetSelector: {
    ...
    overview: {
      ...
      emptySubtitle: "Please upload a CSV file on the Input page",
      uploadData: "Upload Data",
      loadingMetrics: "Loading metrics...",
      brandContextTitle: "Insta360 Brand Context",
      brandContextSubtitle: "Auto-enriched brand and site research",
      ...
      placeholders: { selectDataset: "Select Dataset", status: "Status" },
      kpis: {
        activeRatio: "Active Ratio", contentShare: "Content GMV Share", dealShare: "Deal GMV Share",
        gmvPerActive: "GMV/Active Publisher", top10Share: "Top10 GMV Share", approvalRate: "Approval Rate",
        totalGmv: "Total GMV", publishersTo50: "Publishers for 50% GMV",
      },
      labels: {
    ...
    reportCenter: {
      title: "Report Center", subtitle: "Research-backed affiliate report with market, competitor, and keyword appendix",
      ...
      chapterLabel: "Chapter", refresh: "Refresh", loading: "Loading...", updatedAt: "Updated", cacheHit: "Cached Research", sources: "Research Sources",
      ...
      findingLabels: { trigger: "Trigger", action: "Action", owner: "Owner", due: "Due" },
      downloads: { pdf: "Download PDF", markdown: "Download Markdown" },
      ...
      chapters: [
        { title: "Executive Summary", desc: "Board-ready summary tying KPIs to market context and priority actions" },
        { title: "Activation Funnel", desc: "Activation health, dormant partners, and reactivation plays" },
        { title: "Concentration Analysis", desc: "Pareto risk, Top10 dependence, and diversification priorities" },
        { title: "Mix Health", desc: "Coverage gaps, structural balance, and recruitment direction" },
        { title: "Efficiency Quadrant", desc: "Cost, order volume, and scale-or-cleanup decisions" },
        { title: "Approval & Quality", desc: "Transaction quality, approval breakdown, and governance clues" },
        { title: "Tier Management", desc: "Tiered partner operating model and cadence" },
        { title: "Action Plan", desc: "30/60/90-day affiliate operating plan with owners" },
        { title: "Timeline & Roadmap", desc: "Phased execution roadmap and milestones" },
        { title: "Data Quality Assessment", desc: "Limits, partial coverage, and confidence notes" },
        { title: "Appendix - Methodology", desc: "How the KPIs, research, and synthesis were built" },
        { title: "Category Landscape", desc: "Demand signals, merchandising norms, and affiliate fit" },
        { title: "Competitor Benchmark", desc: "Competitor positioning, pricing, promos, and affiliate takeaways" },
        { title: "Keyword Opportunity Map", desc: "Brand, category, competitor, and modifier keyword themes" },
        { title: "Brand Positioning & Creative Hooks", desc: "Brand narrative, proof points, and creative angles" },
        { title: "Research Sources", desc: "Inline citations and confidence notes behind the report" },
      ],
    },
    dataCenter: {
